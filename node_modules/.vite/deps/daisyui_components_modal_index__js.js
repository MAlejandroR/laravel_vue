...
// node_modules/daisyui/components/modal/index.js
var modal_default = ({ addComponents, prefix = "" }) => {
  const prefixedmodal = addPrefix(object_default, prefix);
  addComponents({ ...prefixedmodal });
};
export {
  modal_default as default
};
//# sourceMappingURL=daisyui_components_modal_index__js.js.map
